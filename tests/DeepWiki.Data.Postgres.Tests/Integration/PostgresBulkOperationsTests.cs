...
/// <summary>
/// Integration tests for bulk operations on PostgreSQL vector store.
...
public class PostgresBulkOperationsTests : IAsyncLifetime
{
    ...
    public PostgresBulkOperationsTests()
    {
    ...
    public async Task BulkUpsert_WithDuplicateIds_ShouldFailOnSave()
    {
        ...
        // Act & Assert - duplicate ID should fail on insert with DbUpdateException
