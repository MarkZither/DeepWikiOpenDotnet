...
✅ **PostgreSQL with pgvector** - Managed by Aspire (automatic container)  
✅ **Ollama embeddings** - Using local Ollama at http://localhost:11434  
✅ **Document ingestion** - POST /api/documents/ingest  
✅ **Semantic search** - POST /api/query  
